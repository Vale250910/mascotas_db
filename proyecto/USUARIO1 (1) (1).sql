...
(1, 'Consulta General', 'Consulta veterinaria general', 50000.00),
(2, 'Vacunación', 'Aplicación de vacunas', 35000.00),
(3, 'Desparasitación', 'Tratamiento antiparasitario', 30000.00),
(4, 'Cirugía', 'Procedimiento quirúrgico', 200000.00),
(5, 'Peluquería', 'Servicio de peluquería para mascotas', 40000.00);
SELECT * FROM servicios;

INSERT INTO citas (codigo, fecha, hora, id_servicio, id_veterinario, codigo_mascota, estado) VALUES
(1001, '2024-08-20', '10:00:00', 1, 105, 1001, 'CONFIRMADA'),
(1002, '2024-08-21', '11:00:00', 2, 106, 1002, 'PENDIENTE'),
(1003, '2024-08-22', '12:00:00', 3, 107, 1003, 'CANCELADA'),
(1004, '2024-08-23', '09:00:00', 4, 108, 1001, 'REALIZADA'),
(1005, '2024-08-24', '14:00:00', 5, 109, 1002, 'NO_ASISTIDA');
SELECT*FROM citas;

INSERT INTO historial_medico (codigo, fecha, descripcion, tratamiento, codigo_mascota) VALUES
(1, '2024-07-01', 'Revisión general', 'Administrar antiparasitarios', 1001),
(2, '2024-07-10', 'Vacunación', 'Vacuna contra la rabia aplicada', 1002),
(3, '2024-07-15', 'Cirugía menor', 'Extracción de quiste', 1003),
(4, '2024-08-05', 'Consulta por alergias', 'Administrar antihistamínicos', 1001),
(5, '2024-08-10', 'Consulta de control', 'Chequeo general', 1002);
SELECT*FROM historial_medico;

INSERT INTO productos (codigo, nombre, descripcion, precio, stock) VALUES
(1, 'Alimento para Perro', 'Alimento balanceado para perros adultos', 45000.00, 50),
(2, 'Alimento para Gato', 'Alimento balanceado para gatos adultos', 50000.00, 40),
(3, 'Juguete para Perro', 'Pelota resistente para perros', 15000.00, 100),
(4, 'Collar Antipulgas', 'Collar para prevención de pulgas y garrapatas', 35000.00, 75),
(5, 'Arena para Gatos', 'Arena higiénica para gatos', 20000.00, 60);
